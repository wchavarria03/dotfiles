local function create_and_open_zk_note()
	...
	if title then
		-- Construct and execute the zn command
		-- local cmd = string.format('zn new --vim "%s"', title)
		local cmd = string.format('/Users/wchavarria/personal/dotfiles/scripts/note.sh "%s"', title)
