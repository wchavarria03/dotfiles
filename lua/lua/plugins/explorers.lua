...
local function on_attach(bufnr)
	...
	utils.mapKey(
		...
		merge_tb("force", opts, { desc = "Parent Directory" })
	)
	utils.mapKey(
		"NVIM-TREE",
		"n",
		...
		merge_tb("force", opts, { desc = "Close Directory" })
	)
	...
	utils.mapKey(
		...
		merge_tb("force", opts, { desc = "Collapse All" })
	)
	utils.mapKey(
		"NVIM-TREE",
		"n",
		...
		merge_tb("force", opts, { desc = "Copy Relative Path" })
	)
	utils.mapKey(
		"NVIM-TREE",
		"n",
		...
		merge_tb("force", opts, { desc = "Copy Absolute Path" })
	)
	utils.mapKey(
		"NVIM-TREE",
		"n",
		"<leader>to",
		":lua OpenNodeInFinder()<CR>",
		merge_tb("force", opts, { desc = "Open Finder" })
	)
end
