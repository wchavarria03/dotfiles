...
setup_symblinks() {
    ...
    ln -s ~/code/dotfiles/lua-config/init.lua ~/.config/nvim/init.lua

    echo "${COLOR_GREEN}- Lua folder symlink${COLOR_REST}"
    ln -s ~/code/dotfiles/lua-config/lua ~/.config/nvim/lua

    echo "${COLOR_GREEN}- Lazy Nvim lazy-lock symlink${COLOR_REST}"
    ln -s ~/code/dotfiles/lua-config/lazy-lock.json ~/.config/nvim/lazy-lock.json

    echo "${COLOR_GREEN}- Stylua config symlink${COLOR_REST}"
    ln -s ~/code/dotfiles/lua-config/stylua.toml ~/.config/nvim/stylua.toml
